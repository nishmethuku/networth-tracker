...
def delete_household(household_id, requester_id):
    ...
    entries, budget limits, budget categories, accounts, liabilities,
    milestones) just gets unshared (household_id -> NULL) and reverts to
    being that member's private data, matching how sharing already works
